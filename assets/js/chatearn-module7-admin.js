...
(() => {
  ...
  const VERSION = '8F.7';
  const registry = [
    { key:'7B', flag:'__CHAT_EARN_MODULE_7B3__', src:'./assets/js/chatearn-v7-admin-withdrawals.js?v=7.3.0' },
    ...
    { key:'8E', flag:'__CHAT_EARN_V8E7_DIRECT_WITHDRAWAL__', src:'./assets/js/chatearn-v8e-direct-withdrawal-flow.js?v=8.7.0' },
    { key:'8F', flag:'__CHAT_EARN_V8F1_STABILIZER__', src:'./assets/js/chatearn-v8f-final-stabilizer.js?v=8.1.0' }
  ];
  ...
  function load(module) {if (window[module.flag] || document.querySelector(`script[data-chatearn-module="${module.key}"]`)) return;const script=document.createElement('script');script.src=module.src;script.defer=true;script.dataset.chatearnModule=module.key;script.onload=()=>failures.delete(module.key);script.onerror=()=>failures.set(module.key,'load_failed');document.head.appendChild(script)}
