...
(() => {
  ...
  const registry = [
    ...
    { key: 'chat-task-admin', flag: '__CHAT_EARN_CHAT_TASK_ADMIN__', src: './assets/js/chatearn-chat-task-admin.js?v=2.0.0' },
    { key: 'first-cycle-task-runtime', flag: '__CHAT_EARN_FIRST_CYCLE_TASK_RUNTIME__', src: './assets/js/chatearn-first-cycle-and-task-runtime.js?v=1.0.0' },
  ...
  window.ChatEarnModule7Diagnostic = () => ({
    ...
    firstCycleTaskRuntime: window.ChatEarnFirstCycleTaskRuntime?.version || null,
