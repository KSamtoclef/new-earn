...
(() => {
  ...
  const registry = [
    ...
    { key: 'sponsored-ads-stability', flag: '__CHAT_EARN_SPONSORED_ADS_STABILITY__', src: './assets/js/chatearn-sponsored-ads-stability.js?v=1.2.0' },
