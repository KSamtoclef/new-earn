...
(() => {
  ...
  const VERSION = '8F.1';
  const registry = [
    { key:'7B', flag:'__CHAT_EARN_MODULE_7B__', src:'./assets/js/chatearn-v7-admin-withdrawals.js?v=7.1.1' },
    { key:'7C', flag:'__CHAT_EARN_MODULE_7C__', src:'./assets/js/chatearn-v7-admin-kyc.js?v=7.1.1' },
    { key:'8D', flag:'__CHAT_EARN_V8D3_FLOW__', src:'./assets/js/chatearn-v8d-offer-withdrawal-flow.js?v=8.3.1' },
    { key:'8E', flag:'__CHAT_EARN_V8E2_DIRECT_WITHDRAWAL__', src:'./assets/js/chatearn-v8e-direct-withdrawal-flow.js?v=8.2.1' },
  ...
  window.ChatEarnModule7Diagnostic = () => ({
    ...
    stabilizer:window.ChatEarnV8FDiagnostic?.() || null,
