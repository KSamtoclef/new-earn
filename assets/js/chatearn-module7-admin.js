...
(() => {
  ...
  const VERSION = 'canonical-1.2.3';
  const failures = new Map();
  const loaded = new Set();
  const registry = [
    { key: 'offers-sharing', flag: '__CHAT_EARN_V8D7_FLOW__', src: './assets/js/chatearn-v8d-offer-withdrawal-flow.js?v=8.7.0' },
    { key: 'withdrawal', flag: '__CHAT_EARN_V8E11_DIRECT_WITHDRAWAL__', src: './assets/js/chatearn-v8e-direct-withdrawal-flow.js?v=8.11.0' },
