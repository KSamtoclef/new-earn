...
(() => {
  ...
  const VERSION = 'canonical-1.1.0';
  const failures = new Map();
  const loaded = new Set();
  const registry = [
    { key: 'offers-sharing', flag: '__CHAT_EARN_V8D3_FLOW__', src: './assets/js/chatearn-v8d-offer-withdrawal-flow.js?v=8.3.1' },
    { key: 'withdrawal', flag: '__CHAT_EARN_V8E8_DIRECT_WITHDRAWAL__', src: './assets/js/chatearn-v8e-direct-withdrawal-flow.js?v=8.8.0' },
