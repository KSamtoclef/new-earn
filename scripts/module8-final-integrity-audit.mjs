...
/**
 * ChatEarn Module 8 — final static integrity audit.
 *
...
if (failed.length) {
  console.error('Module 8 final static integrity audit failed.');
  process.exitCode = 1;
} else {
  console.log('Module 8 final static integrity audit passed.');
}
