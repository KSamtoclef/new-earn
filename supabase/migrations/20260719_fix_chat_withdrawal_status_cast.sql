-- Fix the exact enum-cast bug in public.chatearn_send_message.
-- The previous expression coalesced an enum with an empty string, causing
-- PostgreSQL to cast '' to public.withdrawal_status before lower() ran.
